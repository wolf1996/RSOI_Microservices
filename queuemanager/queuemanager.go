...
func parseViper() manager.Config {
	...
	return manager.Config{manager.RabbitConfig{addres, user, pass}, eventsclient.Config{eventServiceAddres, crtEvent, eventsclient.QConfig{addres, user, pass}},
		userclient.Config{userServiceAddres, crtUser, userclient.QConfig{addres, user, pass}}}
}
